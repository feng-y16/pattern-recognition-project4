...
#######################################################################################################
#作图
plot_Cmeans2_combined(train_data_extracted,train_label_pred,test_data_extracted,test_label_pred,mean_one,mean_two,"Original C means classification (2 clusters)")