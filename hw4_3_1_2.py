...
#######################################################################################################
#作图
plot_Cmeans3_combined(train_data_extracted,train_label_pred,test_data_extracted,test_label_pred,mean_one,mean_two,mean_three,"Unnormalized C means classification (3 clusters)")
