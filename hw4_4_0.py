...
print("cases")
#Train:
#label=0, predict label=0——64cases
#label=0, predict label=1——1cases
#label=1, predict label=1——0cases
#label=1, predict label=0——302cases
...
print("cases")
#All:
#label=0, predict label=0——79cases
#label=0, predict label=1——2cases
#label=1, predict label=1——0cases
#label=1, predict label=0——377cases
#计算可得
#Test:
#label=0, predict label=0——15ases
#label=0, predict label=1——1cases
#label=1, predict label=1——0cases
#label=1, predict label=0——75cases