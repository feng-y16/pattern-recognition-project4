...
print("cases")
#Train:
#label=0, predict label=0——52cases
#label=0, predict label=1——13cases
#label=1, predict label=1——296cases
#label=1, predict label=0——6cases
...
print("cases")
#All:
#label=0, predict label=0——66cases
#label=0, predict label=1——15cases
#label=1, predict label=1——370cases
#label=1, predict label=0——7cases
#计算可得
#Test:
#label=0, predict label=0——14cases
#label=0, predict label=1——2cases
#label=1, predict label=1——74cases
#label=1, predict label=0——1cases